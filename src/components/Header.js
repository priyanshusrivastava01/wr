/* ============================================
   HEADER COMPONENT
   ============================================
   Shared header across the 3-level site architecture.
   ============================================ */
...
function initHeaderBehavior() {
  ...
  // Drawer links
  drawerWrapper?.querySelectorAll('.mobile-drawer-link, .mobile-find-space, .mobile-build-warehouse, .mobile-drawer-brand').forEach(link => {
